  ...
  return (
    <>
      ...
      <div className="flex gap-5 max-w-full flex-col items-center bg-[#fff3e9] text-[#110931]">
        <div
          className="container-login flex flex-col border items-center justify-center gap-4 p-10  bg-[#fff3e9] rounded-xl shadow-md"
          style={{ boxShadow: "0px 4px 8px rgba(25, 14, 3, 0.4)" }}
        >
          <img className="h-[200px] w-[200px]" src={Logo} alt="" />

          <p className="good-deeds-slogan">
            Join the Movement for Positive Social Change: Volunteer Peer-to-Peer
            and make an impact in your area today!
          </p>
              ...
              <div className="flex gap-20">
                <div className="w-[350px] p-5">
                  ...
                  <p>
                    ...
                    feelings by releasing dopamine. By spending time in service
                    to others, volunteers report feeling a sense of meaning and
                ...
                <div className="w-[350px] p-5">
                  ...
                  <p>
                    ...
                    support system based on common interests. One of the best
                    ways to make new friends and strengthen existing
                    relationships is to participate in a shared activity.
                    Dedicating time as a volunteer helps expand social network
