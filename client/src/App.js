              ...
              <div className="benefits-card-container">
                ...
                >
                  <div className="benefits-card">
                    ...
                    <p className="benefits-p">
                      ...
                      in service to others, volunteers report feeling a sense of
                      meaning and appreciation, both given and received, which
                ...
                >
                  <div className="benefits-card">
                    ...
                    <p className="benefits-p">
                      ...
                      meaningful. Older volunteers experience greater increases
                      in life satisfaction and self-esteem.
                    </p>
                  </div>
                </Paper>
                ...
                >
                  <div className="benefits-card">
                    ...
                    <p className="benefits-p">
                      Volunteering increases social interaction and helps build
                      a support system based on common interests. One of the
                      best ways to make new friends and strengthen existing
                      relationships is to participate in a shared activity.
                    </p>
                  </div>
                </Paper>
              </div>
          ...
          <section>
            <div className="about-us-container">
              ...
              <p className="about-us-p">
                ...
                everyone has the power to make a difference and that small acts
                of kindness can have a big impact. We aim to bring people
                together and create a sense of community through volunteering
                and giving back. At Good Deeds, we offer a range of volunteer
                opportunities that cater to different interests and skillsets.
                Whether you're passionate about the environment, social justice,
                or helping those in need, we have a role for you. We believe
                that volunteering should be accessible to everyone, which is why
                we offer flexible hours and a supportive community to help you
                get started. Our volunteers are the heart and soul of our
                organisation, and we value their time and dedication. We aim to
                create a positive and inclusive environment where everyone feels
                welcome and valued. We believe that through our collective
                efforts, we can create a stronger and more connected community.
                Join us today and become a part of something bigger. Together,
