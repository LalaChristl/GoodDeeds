...
import GD from "../images/about-us-logo.png";
          ...
          <section className="about-us-mission-container">
            ...
            <div className="about-us-mission-div-2">
              ...
              <p className="about-us-mission-p">
                ...
                build a more connected and compassionate community by
                facilitating volunteer opportunities that bring people together
                to address common challenges, support local causes, and make a
                positive impact. By fostering a culture of giving,
                collaboration, and empathy, we aim to inspire individuals to
                take action, create meaningful connections, and build a better
                world for everyone.
              </p>
            </div>
          </section>
            ...
            <div className="about-us-history-container">
              <div className="about-us-history-div-1">
                ...
                <p className="about-us-history-p">
                  ...
                  community. We looked into various volunteer opportunities, but
                  we found that most organizations were focused on specific
                  causes and required a long-term commitment, which didn't fit
                  with our busy schedules. We realized that there was a gap in
                  our community for a flexible, short-term volunteer
                  organization that could match volunteers with a variety of
                  different people and projects. So, we decided to start our own
                  volunteer organization. Together, we formed a small team and
                  started researching the needs of our community. We found that
                  there are so many people that could benefit from short-term
                  volunteer help. We created an app to spread the word and
                  promote our cause. We are now able to match volunteers with a
                  variety of people in their community. Over time, we hope our
                  organization will grow and we are able to expand our services
                  to other communities in need and make a meaningful impact on
                  the world.
                </p>
              </div>
